  ...
  return (
    ...
    >
      ...
      <div className="bg-white rounded-2xl border-[3px] border-[#1a1a2e] p-3">
        <h3 className="text-lg font-black text-[#1a1a2e] leading-tight">{pickLocalized(scene.title, language)}</h3>
        <p className="text-xs text-[#1a1a2e]/70 font-semibold mt-1 leading-snug">{pickLocalized(scene.description, language)}</p>
