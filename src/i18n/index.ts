...
const zh: Dict = {
  ...
  'report.scoreboard': '🏆 EQ SCOREBOARD',
  'report.core': '🧠 情商内核',
  'report.history': '📜 历史对标',
  'report.comment': '🎯 社交画像',
  'report.share': '📣 分享文案',
  ...
  'report.shareTemplate': '我在「我是高情商」挑战中获得 {score} 分，段位：{emoji} {level}！{copy}\n\n👉 来测测你的情商：https://www.vectorfuture.xyz/',
  'report.hellMode': '🔥 地狱模式',
  'report.hellModeDesc': '混合所有场景的高难度题目，地狱级挑战',
  'report.hellModeLocked': '🔒 完成所有场景后解锁地狱模式',
  'report.hellModeEnter': '⚔️ 进入地狱',
  'report.hellModeWarning': '⚠️ 警告：此模式会随机混合所有场景题目，难度地狱级，心理脆弱者慎入！',
  'report.hellModeConfirm': '我已准备好，接受挑战',
  'report.hellModeCancel': '算了，我怂了',
  'report.hellModeTitle': '🔥 地狱模式已激活 🔥',
  'report.hellModeSubtitle': '所有场景题目随机混合 · 没有退路',
...
const en: Dict = {
  ...
  'report.hellMode': '🔥 Hell Mode',
  'report.hellModeDesc': 'Hardest questions mixed from all scenes — hell level',
  'report.hellModeLocked': '🔒 Unlock Hell Mode by completing all scenes',
  'report.hellModeEnter': '⚔️ Enter Hell',
  'report.hellModeWarning': '⚠️ Warning: This mode randomly mixes all scene questions. Hell difficulty. Not for the faint-hearted!',
  'report.hellModeConfirm': 'I am ready. Accept the challenge',
  'report.hellModeCancel': 'Nah, I am out',
  'report.hellModeTitle': '🔥 HELL MODE ACTIVATED 🔥',
  'report.hellModeSubtitle': 'All scenes mixed randomly · No way back',
